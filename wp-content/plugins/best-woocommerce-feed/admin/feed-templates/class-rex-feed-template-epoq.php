...
/**
 *
 * Defines the attributes and template for Epoq feed.
 *
 * @package    Rex_Product_Feed
 * @subpackage Rex_Product_Feed/admin/feed-templates/Rex_Feed_Template_Epoq
 * @author     RexTheme <info@rextheme.com>
 */
class Rex_Feed_Template_Epoq extends Rex_Feed_Abstract_Template {
