...
/**
 * The Family_blend Feed Template class.
 *
...
/**
 *
 * Defines the attributes and template for family_blend feed.
 *
 * @package    Rex_Product_Feed
 * @subpackage Rex_Product_Feed/admin/feed-templates/Rex_Feed_Template_Family_blend
 * @author     RexTheme <info@rextheme.com>
 */
class Rex_Feed_Template_Family_blend extends Rex_Feed_Abstract_Template {
