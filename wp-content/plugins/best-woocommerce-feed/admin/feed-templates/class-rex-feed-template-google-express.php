...
/**
 * The Google Express marketplace Feed Template class.
 *
...
/**
 *
 * Defines the attributes and template for Google Express marketplace feed.
 *
 * @package    Rex_Product_Feed
 * @subpackage Rex_Product_Feed/admin/feed-templates/Rex_Feed_Template_Google_express
 * @author     RexTheme <info@rextheme.com>
 */
class Rex_Feed_Template_Google_express extends Rex_Feed_Abstract_Template {
