...
/**
 * The pricefalls Feed Template class.
 *
...
/**
 *
 * Defines the attributes and template for pricefalls feed.
 *
 * @package    Rex_Product_Feed
 * @subpackage Rex_Product_Feed/admin/feed-templates/Rex_Feed_Template_Pricefalls
 * @author     RexTheme <info@rextheme.com>
 */
class Rex_Feed_Template_Pricefalls extends Rex_Feed_Abstract_Template {
