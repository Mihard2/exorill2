...
/**
 * The Rakuten-advertising marketplace Feed Template class.
 *
...
/**
 *
 * Defines the attributes and template for Rakuten-advertising marketplace feed.
 *
 * @package    Rex_Product_Feed
 * @subpackage Rex_Product_Feed/admin/feed-templates/Rex_Feed_Template_Rakuten_advertising
 * @author     RexTheme <info@rextheme.com>
 */
class Rex_Feed_Template_Rakuten_advertising extends Rex_Feed_Abstract_Template {
