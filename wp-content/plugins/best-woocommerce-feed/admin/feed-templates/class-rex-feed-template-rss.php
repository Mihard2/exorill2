 ...
 *
 * @package    Rex_Product_Feed
 * @subpackage Rex_Product_Feed/admin/feed-templates/Rex_Feed_Template_Rss
 * @author     RexTheme <info@rextheme.com>
 */
class Rex_Feed_Template_Rss extends Rex_Feed_Abstract_Template {
