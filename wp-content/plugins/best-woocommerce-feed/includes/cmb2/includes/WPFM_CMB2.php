<?php
/**
 * WPFM_CMB2 - The core metabox object
 *
...
/**
 * The main WPFM_CMB2 object for storing box data/properties.
 */
class WPFM_CMB2 extends WPFM_CMB2_Base {
	...
	protected $mb_defaults = array(
		...
		'cmb_styles'       => true, // Include WPFM_CMB2 stylesheet.
		'enqueue_js'       => true, // Include WPFM_CMB2 JS.
		'fields'           => array(),

		/*
		 * Handles hooking WPFM_CMB2 forms/metaboxes into the post/attachement/user/options-page screens
		...
		'show_in_rest'     => false,
		'classes'          => null, // Optionally add classes to the WPFM_CMB2 wrapper
		'classes_cb'       => '', // Optionally add classes to the WPFM_CMB2 wrapper (via a callback)
		...
		'display_cb'       => false, // Override the options-page form output (WPFM_CMB2_Hookup::options_page_output()).
	...
	/**
	 * Whether there are fields to be shown in columns. Set in WPFM_CMB2::add_field().
	 *
	 * @var   bool
	 * @since 2.2.2
	 */
	...
	public function __construct( $config, $object_id = 0 ) {
		...
		WPFM_CMB2_Boxes::add( $this );

		/**
		 * Hook during initiation of WPFM_CMB2 object
		 *
		 * The dynamic portion of the hook name, $this->cmb_id, is this meta_box id.
		 *
		 * @param array $cmb This WPFM_CMB2 object
		 */
	...
	/**
	 * Defines the classes for the WPFM_CMB2 form/wrap.
	 *
	 * @since  2.0.0
	...
	public function box_classes() {
		 ...
		 * @param WPFM_CMB2   $cmb     This WPFM_CMB2 object.
		 */
	 ...
	 * @return mixed WPFM_CMB2_Field object if successful.
	 */
	 ...
	 *
	 * @param array|WPFM_CMB2_Field $args Array of field arguments for a group field parent or the group parent field.
	 * @return WPFM_CMB2_Field|null Group field object.
	 */
	public function render_group( $args ) {
		$field_group = false;

		if ( $args instanceof WPFM_CMB2_Field  ) {
	 ...
	 * @param  WPFM_CMB2_Field $field_group The WPFM_CMB2_Field group object.
	 *
	 * @return WPFM_CMB2_Field|null Group field object.
	 */
	 ...
	 *
	 * @since  2.2.3
	 * @param  WPFM_CMB2_Field $field_group The group WPFM_CMB2_Field object.
	...
	public function group_wrap_attributes( $field_group ) {
		...
		foreach ( $group_wrap_attributes as $att => $att_value ) {
			if ( ! WPFM_CMB2_Utils::is_data_attribute( $att ) ) {
		...
		return WPFM_CMB2_Utils::concat_attrs( $atts );
	}
	 ...
	 *
	 * @since  1.0.2
	 * @param  WPFM_CMB2_Field $field_group     WPFM_CMB2_Field group field object.
	 *
	 * @return WPFM_CMB2
	 */
	 ...
	 *
	 * @since 2.0.0
	 * @param array           $field_args  Array of field arguments to be passed to WPFM_CMB2_Field.
	 * @param WPFM_CMB2_Field|null $field_group WPFM_CMB2_Field group field object.
	 */
	public function add_hidden_field( $field_args, $field_group = null ) {
		if ( isset( $field_args['field_args'] ) ) {
			// For back-compatibility.
			$field = new WPFM_CMB2_Field( $field_args );
		} else {
			$field = $this->get_new_field( $field_args, $field_group );
		}

		$types = new WPFM_CMB2_Types( $field );
	 ...
	 * @return mixed        Return of WPFM_CMB2_Field::update_data().
	 */
	...
	public function save_group_field( $field_group ) {
		...
		foreach ( array_values( $field_group->fields() ) as $field_args ) {
			...
			foreach ( (array) $group_vals as $field_group->index => $post_vals ) {
				...
				$is_updated = ( ! WPFM_CMB2_Utils::isempty( $new_val ) && $new_val !== $old_val );
				$is_removed = ( WPFM_CMB2_Utils::isempty( $new_val ) && ! WPFM_CMB2_Utils::isempty( $old_val ) );
			...
			$saved[ $field_group->index ] = WPFM_CMB2_Utils::filter_empty( $saved[ $field_group->index ] );
		}// End foreach().

		$saved = WPFM_CMB2_Utils::filter_empty( $saved );
	...
	public function box_types( $fallback = array() ) {
		return WPFM_CMB2_Utils::ensure_array( $this->prop( 'object_types' ), $fallback );
	}
	 ...
	 *
	 * @since  2.0.3
	 * @param  string|array|WPFM_CMB2_Field $field        Metabox field id or field config array or WPFM_CMB2_Field object.
	 * @param  WPFM_CMB2_Field|null         $field_group  (optional) WPFM_CMB2_Field object (group parent).
	 * @param  bool                    $reset_cached (optional) Reset the internal cache for this field object.
	 *                                               Use sparingly.
	 *
	 * @return WPFM_CMB2_Field|false                     WPFM_CMB2_Field object (or false).
	 */
	public function get_field( $field, $field_group = null, $reset_cached = false ) {
		if ( $field instanceof WPFM_CMB2_Field ) {
			return $field;
		}
		...
		$this->fields[ $index ] = new WPFM_CMB2_Field( $this->get_field_args( $field_id, $field, $sub_field_id, $field_group ) );

		return $this->fields[ $index ];
	}

	/**
	 * Handles determining which type of arguments to pass to WPFM_CMB2_Field
	 *
	 * @since  2.0.7
	 * @param  mixed           $field_id     Field (or group field) ID.
	 * @param  mixed           $field_args   Array of field arguments.
	 * @param  mixed           $sub_field_id Sub field ID (if field_group exists).
	 * @param  WPFM_CMB2_Field|null $field_group  If a sub-field, will be the parent group WPFM_CMB2_Field object.
	 * @return array                         Array of WPFM_CMB2_Field arguments.
	 */
	...
	public function add_field( array $field, $position = 0 ) {
		...
		switch ( $field['type'] ) {
			...
			case 'file_list':
				...
				add_filter( 'wp_prepare_attachment_for_js', array( 'WPFM_CMB2_Type_File_Base', 'prepare_image_sizes_for_js' ), 10, 3 );
				break;
			...
			case 'group':
				...
				break;
			case 'colorpicker':
				// https://github.com/JayWood/WPFM_CMB2_RGBa_Picker
				// Dequeue the rgba_colorpicker custom field script if it is used,
				// since we now enqueue our own more current version.
				add_action( 'admin_enqueue_scripts', array( 'WPFM_CMB2_Type_Colorpicker', 'dequeue_rgba_colorpicker_script' ), 99 );
				break;
		}
	...
	protected function _add_field_to_array( $field, &$fields, $position = 0 ) {
		if ( $position ) {
			WPFM_CMB2_Utils::array_insert( $fields, array( $field['id'] => $field ), $position );
		} else {
