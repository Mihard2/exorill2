 ...
 * @method mixed fields()
 */
class WPFM_CMB2_Field extends WPFM_CMB2_Base {
	...
	/**
	 * All WPFM_CMB2_Field callable field arguments.
	...
	public function get_data( $field_id = '', $args = array() ) {
		 ...
		 * }
		 *
		 * @param WPFM_CMB2_Field object $field This field object
		 */
	...
	public function sanitization_cb( $meta_value ) {
		...
		$sanitizer = new WPFM_CMB2_Sanitize( $this, $meta_value );
		 ...
		 * @param object     $sanitizer  This `WPFM_CMB2_Sanitize` object
		 */
		...
		// Sanitization via 'WPFM_CMB2_Sanitize'
	...
	public function save_field( $meta_value ) {
		...
		} elseif ( ! WPFM_CMB2_Utils::isempty( $new_value ) && $new_value !== $this->get_data() ) {
			$updated = $this->update_data( $new_value );
			$action  = 'updated';
		} elseif ( WPFM_CMB2_Utils::isempty( $new_value ) ) {
	...
	public function escaped_value( $func = 'esc_attr', $meta_value = '' ) {
		 ...
		 * @param array      $field_args The current field's arguments.
		 * @param object     $field      This `WPFM_CMB2_Field` object.
		 */
	...
	public function val_or_default( $meta_value ) {
		return ! WPFM_CMB2_Utils::isempty( $meta_value ) ? $meta_value : $this->get_default();
	}
	...
	public function field_timezone_offset() {
		return WPFM_CMB2_Utils::timezone_offset( $this->field_timezone() );
	}
	...
	public function get_timestamp_format( $format = 'date_format', $meta_value = 0 ) {
		...
		$meta_value = WPFM_CMB2_Utils::make_valid_time_stamp( $meta_value );
	...
	public function get_timestamp_from_value( $value ) {
		return WPFM_CMB2_Utils::get_timestamp_from_value( $value, $this->args( 'date_format' ) );
	}
	...
	public function render_field_callback() {
		...
		$types = new WPFM_CMB2_Types( $this );
		$types->render();
	...
	/**
	 * Defines the classes for the current WPFM_CMB2 field row
	 *
	 * @since  2.0.0
	...
	public function display_value_callback() {
		...
		$display = new WPFM_CMB2_Field_Display( $this );
		$field_type = $this->type();
		 ...
		 * @param WPFM_CMB2_Field         $field      This field object.
		 * @param WPFM_CMB2_Field_Display $display    The `WPFM_CMB2_Field_Display` object.
		 */
		...
		WPFM_CMB2_Field_Display::get( $this )->display();
	...
	public function add_js_dependencies( $dependencies = array() ) {
		...
		WPFM_CMB2_JS::add_dependencies( $dependencies );
	}
	...
	public function register_js_data() {
		if ( $this->group ) {
			WPFM_CMB2_JS::add_field_data( $this->group );
		}

		return WPFM_CMB2_JS::add_field_data( $this );
	}
	...
	public function hash_id() {
		if ( '' === $this->hash_id ) {
			$this->hash_id = WPFM_CMB2_Utils::generate_hash( $this->cmb_id . '||' . $this->id() );
		}
	...
	/**
	 * Get WPFM_CMB2_Field default value, either from default param or default_cb param.
	 *
	 * @since  0.2.2
	 *
	...
	public function _set_field_defaults( $args ) {
		...
		$args['has_supporting_data'] = in_array(
			$args['type'],
			array(
				// WPFM_CMB2_Sanitize::_save_file_id_value()/WPFM_CMB2_Sanitize::_get_group_file_value_array()
				'file',
				// See WPFM_CMB2_Sanitize::_save_utc_value()
				'text_datetime_timestamp_timezone',
			),
			true
		);
	 ...
	 *                           arguments for WPFM_CMB2_Field
	 *
	 * @return WPFM_CMB2_Field         The new WPFM_CMB2_Field instance.
	 */
	...
	/**
	 * Returns the WPFM_CMB2 instance this field is registered to.
	 *
	 * @since  2.2.2
	 *
	 * @return WPFM_CMB2|WP_Error If new WPFM_CMB2_Field is called without cmb_id arg, returns error.
	 */
