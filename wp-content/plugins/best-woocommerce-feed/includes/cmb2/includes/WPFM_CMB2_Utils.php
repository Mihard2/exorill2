...
class WPFM_CMB2_Utils {
	 ...
	 *
	 * @since  1.0.1
	 * @return string URL to WPFM_CMB2 resources
	 */
	public static function url( $path = '' ) {
		...
		$cmb2_url = self::get_url_from_dir( wpfm_cmb2_dir() );
		 ...
		 */
		self::$url = trailingslashit( apply_filters( 'cmb2_meta_box_url', $cmb2_url, WPFM_CMB2_VERSION ) );
