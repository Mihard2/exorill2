 ...
 * @link      https://cmb2.io
 */
class WPFM_CMB2_Type_Colorpicker extends WPFM_CMB2_Type_Text {
	 ...
	 * @param array      $args
	 */
	public function __construct( WPFM_CMB2_Types $types, $args = array(), $value = '' ) {
	...
	public static function dequeue_rgba_colorpicker_script() {
		if ( wp_script_is( 'jw-cmb2-rgba-picker-js', 'enqueued' ) ) {
			...
			WPFM_CMB2_JS::register_colorpicker_alpha( true );
		}
	}
