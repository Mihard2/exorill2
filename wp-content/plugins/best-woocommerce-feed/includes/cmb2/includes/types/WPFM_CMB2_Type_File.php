 ...
 * @link      https://cmb2.io
 */
class WPFM_CMB2_Type_File extends WPFM_CMB2_Type_File_Base {
	...
	public function render( $args = array() ) {
		...
		// This is not elegant, but compensates for WPFM_CMB2_Types::_id
	...
	public function get_id_field() {
		...
		if ( $this->args['value'] && ! $id_value ) {
			$id_value = WPFM_CMB2_Utils::image_id_from_url( esc_url_raw( $this->args['value'] ) );
		}
