 ...
 * @link      https://cmb2.io
 */
abstract class WPFM_CMB2_Type_Multi_Base extends WPFM_CMB2_Type_Base {
	...
	public function concat_items( $args = array() ) {
		...
		$value = WPFM_CMB2_Utils::normalize_if_numeric( $value );
		...
		foreach ( $options as $opt_value => $opt_label ) {
			...
			if ( $value === WPFM_CMB2_Utils::normalize_if_numeric( $opt_value ) ) {
				$a['checked'] = 'checked';
			}
