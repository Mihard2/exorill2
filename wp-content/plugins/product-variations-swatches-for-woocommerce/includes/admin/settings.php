            ...
            <div class="vi-ui raised">
                <form action="" class="vi-ui form" method="post">
                    ...
                    <div class="vi-ui vi-ui-main top tabular attached menu">
                        <a class="item" data-tab="general"><?php esc_html_e( 'General Settings', 'product-variations-swatches-for-woocommerce' ); ?></a>
                        <a class="item active" data-tab="swatches_profile"><?php esc_html_e( 'Swatches Profile', 'product-variations-swatches-for-woocommerce' ); ?></a>
                        <a class="item" data-tab="product_list"><?php esc_html_e( 'Swatches on Product List', 'product-variations-swatches-for-woocommerce' ); ?></a>
                        <a class="item" data-tab="woo_widget"><?php esc_html_e( 'Swatches on Woo Widgets', 'product-variations-swatches-for-woocommerce' ); ?></a>
                        <a class="item" data-tab="custom_attrs"><?php esc_html_e( 'Custom Attributes', 'product-variations-swatches-for-woocommerce' ); ?></a>
                    </div>
                            ...
                            <tr valign="top">
                                <th>
                                    <label for="vi-wpvs-attribute_double_click-checkbox">
										<?php esc_html_e( 'Clear on Reselect for single product', 'product-variations-swatches-for-woocommerce' ); ?>
                                    </label>
                                </th>
                                <td>
                            ...
                            <tr valign="top">
                                <th>
                                    <label for="vi-wpvs-variation_threshold_single_page">
										<?php esc_html_e( 'Ajax variation threshold on single page', 'product-variations-swatches-for-woocommerce' ); ?>
                                    </label>
                                </th>
                                <td>
                                    <input type="number" min="1" max="100" name="variation_threshold_single_page"
                            ...
                            <tr valign="top">
                                <th>
                                    <label for="vi-wpvs-out_of_stock_variation_disable-checkbox">
										<?php esc_html_e( 'Hide \'out of stock\' variation item', 'product-variations-swatches-for-woocommerce' ); ?>
                                    </label>
                                </th>
                                <td>
                    ...
                    <div class="vi-ui bottom attached tab segment active" data-tab="swatches_profile">
                        <div class="vi-ui blue message">
							<?php esc_html_e( 'The settings allows to design variation swatches', 'product-variations-swatches-for-woocommerce' ); ?>
                        </div>
						<?php
						if ( $count_ids ) {
							for ( $i = 0; $i < $count_ids; $i ++ ) {
                                ...
                                <div class="vi-ui styled fluid accordion vi-wpvs-accordion-wrap vi-wpvs-accordion-wrap-<?php echo esc_attr( $i ); ?>"
                                    ...
                                    <div class="woo-sctr-accordion-info">
                                        <div class="vi-ui toggle checkbox checked" data-tooltip="<?php esc_attr_e( 'Default profile', 'product-variations-swatches-for-woocommerce' ); ?>">
                        ...
                        <p>
                            ...
                            <a class="vi-ui button" href="https://1.envato.market/bd0ek" target="_blank"><?php esc_html_e( 'Unlock This Feature', 'product-variations-swatches-for-woocommerce' ); ?> </a>
                        </p>
                    </div>
                    ...
                    <div class="vi-ui bottom attached tab segment" data-tab="woo_widget">
                        ...
                        <table class="form-table">
                            <tr>
                                <th>
                                    <label><?php esc_html_e( 'Enable', 'product-variations-swatches-for-woocommerce' ); ?></label>
                                </th>
                                <td>
                                    <a class="vi-ui button" href="https://1.envato.market/bd0ek"
                                       target="_blank"><?php esc_html_e( 'Unlock This Feature', 'product-variations-swatches-for-woocommerce' ); ?> </a>
                        ...
                        <div class="vi-ui styled fluid accordion vi-wpvs-accordion-wrap">
                            <div class="woo-sctr-accordion-info">
                                <span>
                                    <h4><span class="vi-wpvs-accordion-name"><?php esc_html_e( 'Term details', 'product-variations-swatches-for-woocommerce' ); ?></span></h4>
					            </span>
                            </div>
                            <div class="title">
                                <i class="dropdown icon"></i>
                            ...
                            <div class="content">
                                <div class="equal width fields">
                                    <div class="field" data-tooltip="<?php esc_attr_e( 'Display the name of term for color and image type', 'product-variations-swatches-for-woocommerce' ); ?>">
                                        <label><?php esc_html_e( 'Enable name', 'product-variations-swatches-for-woocommerce' ); ?></label>
                                        <a class="vi-ui button" href="https://1.envato.market/bd0ek"
                                           target="_blank"><?php esc_html_e( 'Unlock This Feature', 'product-variations-swatches-for-woocommerce' ); ?> </a>
                                    </div>
                                    <div class="field">
                                    ...
                                    <div class="field">
                                        <label><?php esc_html_e( 'Background', 'product-variations-swatches-for-woocommerce' ); ?></label>
                                        <a class="vi-ui button" href="https://1.envato.market/bd0ek"
                                           target="_blank"><?php esc_html_e( 'Unlock This Feature', 'product-variations-swatches-for-woocommerce' ); ?> </a>
                                    </div>
                                    <div class="field">
                                        <label><?php esc_html_e( 'Box shadow color', 'product-variations-swatches-for-woocommerce' ); ?></label>
                                        <a class="vi-ui button" href="https://1.envato.market/bd0ek"
                                           target="_blank"><?php esc_html_e( 'Unlock This Feature', 'product-variations-swatches-for-woocommerce' ); ?> </a>
                                    </div>
                                    <div class="field vi-wpvs-field-min-width">
                        ...
                        <div class="vi-ui styled fluid accordion vi-wpvs-accordion-wrap">
                            <div class="woo-sctr-accordion-info">
                                <span>
                                    <h4><span class="vi-wpvs-accordion-name"><?php esc_html_e( 'Product count', 'product-variations-swatches-for-woocommerce' ); ?></span></h4>
					            </span>
                            </div>
                            <div class="title">
                                <i class="dropdown icon"></i>
                            ...
                            <div class="content">
                                <div class="equal width fields">
                                    ...
                                    <div class="field">
                                        <label><?php esc_html_e( 'Border color', 'product-variations-swatches-for-woocommerce' ); ?></label>
                                        <a class="vi-ui button" href="https://1.envato.market/bd0ek"
                                           target="_blank"><?php esc_html_e( 'Unlock This Feature', 'product-variations-swatches-for-woocommerce' ); ?> </a>
                                    </div>
                                </div>
                                <div class="equal width fields">
                                    ...
                                    <div class="field vi-wpvs-field-min-width">
                                        <label><?php esc_html_e( 'Border width', 'product-variations-swatches-for-woocommerce' ); ?></label>
                                        <a class="vi-ui button" href="https://1.envato.market/bd0ek"
                                           target="_blank"><?php esc_html_e( 'Unlock This Feature', 'product-variations-swatches-for-woocommerce' ); ?> </a>
                                    </div>
                                    <div class="field">
                                        <label><?php esc_html_e( 'Border radius', 'product-variations-swatches-for-woocommerce' ); ?></label>
                                        <a class="vi-ui button" href="https://1.envato.market/bd0ek"
                                           target="_blank"><?php esc_html_e( 'Unlock This Feature', 'product-variations-swatches-for-woocommerce' ); ?> </a>
                                    </div>
                                </div>
