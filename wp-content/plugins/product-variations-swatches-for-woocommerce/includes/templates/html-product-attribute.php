...
<div data-taxonomy="<?php echo esc_attr( $attribute->get_taxonomy() ); ?>"
    ...
    <h3>
        <a href="#" class="remove_row delete vi-wpvs-attribute-row-remove"><?php esc_html_e( 'Remove', 'product-variations-swatches-for-woocommerce' ); ?></a>
        <div class="handlediv" title="<?php esc_attr_e( 'Click to toggle', 'product-variations-swatches-for-woocommerce' ); ?>"></div>
        <div class="tips sort" data-tip="<?php esc_attr_e( 'Drag and drop to set admin attribute order', 'product-variations-swatches-for-woocommerce' ); ?>"></div>
        ...
        <div class="vi-wpvs-attribute-content vi-wpvs-attribute-content-taxonomy">
            ...
            <div class="vi-wpvs-attribute-info-wrap vi-wpvs-attribute-info-custom-wrap vi-wpvs-hidden">
                <div class="vi-wpvs-attribute-loop-enable">
                    <select title="<?php esc_attr_e( 'Show in product list. Please update Pro version to unlock this feature', 'product-variations-swatches-for-woocommerce' ); ?>">
                        <option value="1" disabled title="<?php esc_attr_e( 'Please update Pro version to unlock this feature', 'product-variations-swatches-for-woocommerce' ); ?>">
							<?php esc_html_e( 'Global product list visibility', 'product-variations-swatches-for-woocommerce' ); ?>
                        </option>
                        <option value="2" disabled title="<?php esc_attr_e( 'Please update Pro version to unlock this feature', 'product-variations-swatches-for-woocommerce' ); ?>">
					...
					foreach ( $all_terms as $k => $term ) {
                        ...
                        <div class="<?php echo esc_attr( $term_class ); ?>"
                            ...
                            <div class="vi-wpvs-attribute-value-content-wrap vi-wpvs-attribute-value-content-close">
								...
								$terms_color_separator  = isset( $vi_attribute_color_separator[ $term->term_id ] ) ? $vi_attribute_color_separator[ $term->term_id ] : null;
								if ( empty( $terms_color_separator ) ) {
									$terms_color_separator = isset( $vi_wpvs_terms_settings['color_separator'] ) ? $vi_wpvs_terms_settings['color_separator'] : '1';
								}
								$terms_colors = isset( $vi_attribute_colors[ $term->term_id ] ) ? $vi_attribute_colors[ $term->term_id ] : null;
								if ( empty( $terms_colors ) ) {
									$terms_colors = isset( $vi_wpvs_terms_settings['color'] ) ? $vi_wpvs_terms_settings['color'] : array();
								}
								$terms_img_id = isset( $vi_attribute_img_ids[ $term->term_id ] ) ? $vi_attribute_img_ids[ $term->term_id ] : null;
								if ( empty( $terms_img_id ) ) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="vi-attribute-image-wrap vi-attribute-edit-image-wrap vi-wpvs-term-image-upload-img">
                                                    ...
                                                    <div><?php esc_html_e( 'Upload / Add image', 'product-variations-swatches-for-woocommerce' ); ?></div>
                                                </div>
                                                <p class="description">
            ...
            <div class="vi-wpvs-attribute-content">
                ...
                <div class="vi-wpvs-attribute-info-wrap vi-wpvs-attribute-info-custom-wrap vi-wpvs-hidden">
                    ...
                    <div class="vi-wpvs-attribute-profile">
                        <select name="vi_attribute_profile[<?php echo esc_attr( $i ); ?>]" title="<?php esc_attr_e( 'Choose swatches profile', 'product-variations-swatches-for-woocommerce' ); ?>">
							<?php
							foreach ( $vi_wpvs_ids as $k => $id ) {
								?>
                                <option value="<?php echo esc_attr( $id ) ?>" <?php selected( $vi_attribute_profile, $id ) ?>><?php echo esc_html( $vi_wpvs_name[ $k ] ); ?></option>
                ...
                <div class="vi-wpvs-attribute-value-wrap-wrap">
					...
					if ( $attribute_options && is_array( $attribute_options ) && count( $attribute_options ) ) {
						foreach ( $attribute_options as $k => $attribute_option ) {
							$attribute_color_separator = isset( $vi_attribute_color_separator[ $k ] ) ? $vi_attribute_color_separator[ $k ] : '1';
							$attribute_colors          = isset( $vi_attribute_colors[ $k ] ) ? $vi_attribute_colors[ $k ] : array();
							$attribute_img_id          = isset( $vi_attribute_img_ids[ $k ] ) ? $vi_attribute_img_ids[ $k ] : '';
