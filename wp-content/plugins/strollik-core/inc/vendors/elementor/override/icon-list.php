 ...
 * @since 1.0.0
 */
class OSF_Widget_Icon_List extends Widget_Icon_List {
	...
	public function get_title() {
		return __( 'Opal Icon List', 'strollik-core' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_icon',
			[
				'label' => __( 'Icon List', 'strollik-core' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'traditional' => [
						'title' => __( 'Default', 'strollik-core' ),
						'icon' => 'eicon-editor-list-ul',
					],
					'inline' => [
						'title' => __( 'Inline', 'strollik-core' ),
						'icon' => 'eicon-ellipsis-h',
					],
				],
				'render_type' => 'strollik-core',
		...
		$repeater->add_control(
			...
			[
				...
				'label_block' => true,
				'placeholder' => __( 'List Item', 'strollik-core' ),
		...
		$this->add_control(
			...
			[
				...
				'default' => [
					[
						'text' => __( 'List Item #1', 'strollik-core' ),
						'icon' => 'fa fa-check',
					],
					[
						'text' => __( 'List Item #2', 'strollik-core' ),
						'icon' => 'fa fa-times',
					],
					[
						'text' => __( 'List Item #3', 'strollik-core' ),
		...
		$this->add_control(
			'text_indent',
			[
				'label' => __( 'Text Indent', 'strollik-core' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'max' => 50,
				...
				<li class="elementor-icon-list-item" >
					...
					if ( ! empty( $item['icon'] ) ) :
						...
						<span class="elementor-icon-list-icon">
							<i class="align-middle <?php echo esc_attr( $item['icon'] ); ?>" aria-hidden="true"></i>
						</span>
					<?php endif; ?>
