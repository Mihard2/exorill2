...
class OSF_Widget_Toggle extends Widget_Toggle {
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'tabs',
			[
				'label' => __( 'Toggle Items', 'strollik-core' ),
				'type' => Controls_Manager::REPEATER,
				'default' => [
					[
						'tab_title' => __( 'Toggle #1', 'strollik-core' ),
						'tab_content' => __( 'I am item content. Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'strollik-core' ),
					],
					[
						'tab_title' => __( 'Toggle #2', 'strollik-core' ),
						'tab_content' => __( 'I am item content. Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'strollik-core' ),
					],
				],
				'fields' => [
					[
						...
						'default' => __( 'Toggle Title' , 'strollik-core' ),
						'label_block' => true,
					],
					[
						'name' => 'tab_content',
						...
						'default' => __( 'Toggle Content', 'strollik-core' ),
						'show_label' => false,
					],
				],
		...
		$this->add_control(
			'icon_active',
			[
				'label' => __( 'Active Icon', 'strollik-core' ),
				'type' => Controls_Manager::ICON,
        ...
        $this->add_control(
            'event_type',
            [
                'label' => __( 'Event Type', 'strollik-core' ),
                'type' => Controls_Manager::SELECT,
                'options' => array(
                    'toggle' => 'Toggle',
                    'accordion' => 'Accordion'
		...
		$this->add_control(
			'tab_active_color',
			[
				'label' => __( 'Active Color', 'strollik-core' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'left' => [
						'title' => __( 'Start', 'strollik-core' ),
						'icon' => 'eicon-h-align-left',
					],
					'right' => [
						'title' => __( 'End', 'strollik-core' ),
