...
class OSF_Widget_Layered_Nav extends WC_Widget {
    ...
    public function __construct() {
        ...
        $this->widget_description = __( 'Display a list of attributes to filter products in your store.(OSF custom)', 'strollik-core' );
        $this->widget_id          = 'otf_woocommerce_layered_nav';
        $this->widget_name        = __( 'OSF Filter Products by Attribute', 'strollik-core' );
        parent::__construct();
    }
    ...
    public function init_settings() {
        ...
        $this->settings = array(
            'title' => array(
                'type'  => 'text',
                'std'   => __( 'Filter by', 'strollik-core' ),
                'label' => __( 'Title', 'strollik-core' ),
            ),
            'attribute' => array(
                'type'    => 'select',
                'std'     => '',
                'label'   => __( 'Attribute', 'strollik-core' ),
                'options' => $attribute_array,
            ),
            'display_type' => array(
                'type'    => 'select',
                'std'     => 'list',
                'label'   => __( 'Display type', 'strollik-core' ),
                'options' => array(
            ...
            'style' => array(
                ...
                'options' => array(
                    'one_column'          => __( '1 Column', 'strollik-core' ),
                    'two_columns'   => __( '2 Columns', 'strollik-core' ),
            ...
            'query_type' => array(
                'type'    => 'select',
                'std'     => 'and',
                'label'   => __( 'Query type', 'strollik-core' ),
                'options' => array(
                    'and' => __( 'AND', 'strollik-core' ),
                    'or'  => __( 'OR', 'strollik-core' ),
                ),
            ),
        );
    }
