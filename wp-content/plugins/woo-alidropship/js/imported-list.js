...
jQuery(document).ready(function ($) {
    ...
    $('.vi-wad-delete-product-options-button-delete').on('click', function () {
        ...
        let woo_product_id = button_delete.data()['woo_product_id'];
        let current_button_delete = $('.vi-wad-button-delete[data-product_id="' + product_id + '"]');
        current_button_delete.addClass('loading');
        ...
        $.ajax({
            ...
            data: {
                ...
                delete_woo_product: $('.vi-wad-delete-product-options-delete-woo-product').prop('checked') ? 1 : 0,
            },
            ...
            complete: function () {
                current_button_delete.removeClass('loading');
            }
        })
    });
    ...
    $('.vi-wad-delete-product-options-button-override').on('click', function () {
        ...
        if (step === 'check') {
            if (!override_product_url) {
                alert('Please enter url of product you want to use to override current product with');
                return;
            }
        } else {
            if (!override_product_data) {
